...
import com.tools.kf.utils.DoubleKeyValueMap;
                ...
                if (method != null) {
                    ...
                    if (AVOID_QUICK_EVENT_SET.contains(eventMethod)) {
                        ...
                        if (timeSpan < QUICK_EVENT_TIME_SPAN) {
                            LogHelper.LogD("onClick cancelled: " + timeSpan);
                            return null;
                        }
                    ...
                    LogHelper.LogD("method not impl: " + eventMethod + "(" + handler.getClass().getSimpleName() + ")");
